...
<center>
        ...
        <tbody>
          ...
          <tr>
            ...
            */
            ...
            <a onMouseover="this.style.cursor='pointer';" onclick="openWin('org!addInput.do?parentId=${parentId }','addOrg',600,200);">添加机构信息</a>
          ...
          <tr>
            ...
            <!-- 可以在这里插入分页导航条 -->
            <pg:pager url="org.do" items="${pager.total }" export="currentPageNumber=pageNumber">
      ...
      <table width="778" border="0" cellPadding="0" cellSpacing="1" bgcolor="#6386d6">
	    ...
	    <tr bgcolor="#EFF3F7" class="TableBody1" onmouseover="this.bgColor = '#DEE7FF';" onmouseout="this.bgColor='#EFF3F7';">
	       ...
	       <td align="center" vAlign="center"><a href="org.do?pager.offset=0&parentId=${org.id }">${org.name }</a></td>
	       <td align="center" vAlign="center">${org.sn }</td>
	       <td align="center" vAlign="center">${org.parent.name }</td>
	       <td align="center" vAlign="center">
	          <a onMouseover="this.style.cursor='pointer';" onclick="del('org!del.do?orgId=${org.id }')">删除</a>
	       </td>
        </tr>
        </c:forEach>
        </c:if>
        ...
        <tbody>
          <tr>
            ...
            */
            %>
            <pg:pager url="org.do" items="${pager.total }" export="currentPageNumber=pageNumber">
            	<pg:param name="orgForm.parent.id"/>
		  		<pg:first>
		  			<a href="${pageUrl }">首页</a>
		  		</pg:first>
		  		<pg:prev>
